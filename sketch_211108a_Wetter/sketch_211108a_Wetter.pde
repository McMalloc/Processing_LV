...
void setup() {
  ...
  blackFont = createFont("Hezaedrus-Black.ttf", 96);
  regFont = createFont("Hezaedrus-Light.ttf", 50);
...
void draw() {
  ...
  fill(0);
  textFont(blackFont);
  text(minTemp + "°", 20+5, 300+5);
  text(maxTemp + "°", 20+5, HEIGHT * 0.85+5);
  
  fill(255);
  textFont(regFont);
  text("heute min.", 20+2, 50+2);
  text("max.", 20+2, HEIGHT * 0.5 + 50+2);
  text("morgen", WIDTH * 0.6+2, 50+2);
  text("übermorgen", WIDTH * 0.85+2, 50+2);
  text(city, 20+2, HEIGHT - 50+2);
  textFont(blackFont);
  textSize(96);
  
  
  text(minTemp + "°", 20+2, 300+2);
  text(maxTemp + "°", 20+2, HEIGHT * 0.85+2);
